  ...
  return (
    <section id="about" className="w-full max-w-7xl mx-auto px-6 py-24 relative z-10">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 auto-rows-[220px]">
        ...
        {/* IDENTITY - BIG BOX */}
        <StarkCard title="Who I Am" subtitle="IDENTITY" className="md:col-span-2 md:row-span-2">
        ...
        <StarkCard title="Zeridex" subtitle="FOUNDER @ 19" className="md:col-span-2">
          <div className="flex flex-col justify-between h-full py-2">
            ...
            <button className="flex items-center gap-2 text-arc-cyan font-bold text-xs uppercase tracking-widest hover:translate-x-2 transition-transform">
